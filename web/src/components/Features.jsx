...
export default function Stats() {
    ...
    const fetchStats = async () => {
      try {
        ...
        const interval = setInterval(() => {
          ...
          setCounters({
            developers: Math.floor(data.developers * progress),
            startups: Math.floor(data.startups * progress),
            funding: Math.floor(data.funding * progress),
            investors: Math.floor(data.investors * progress),
          });
  ...
  const achievements = useMemo(() => [
    { title: "Y Combinator Alumni", description: "50+ startups from our platform" },
    { title: "Techstars Network", description: "25+ accelerated companies" },
    { title: "Series A Success", description: "75+ companies reached Series A" },
    { title: "IPO Exits", description: "3 companies went public" },
    { title: "Unicorn Status", description: "5 companies valued at $1B+" },
    { title: "Global Reach", description: "Active in 50+ countries" },
  ], []);
